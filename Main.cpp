...
int main()
{
	...
	// In this case the viewport goes from (x,y) = (0,0) -> (x,y) = (800,800)
	...
	while (!glfwWindowShouldClose(window)) {
		...
		// Clean the back buffer and assign the new color and depth to it
	...
	// Make sure that we properly destroy the window that has been created.
	glfwDestroyWindow(window);
	glfwTerminate();  // Required for OpenGL Termination
